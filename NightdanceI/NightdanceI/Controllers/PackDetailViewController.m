...
@property(nonatomic, retain) NSDictionary *pack;
...
- (void)viewDidLoad
{
    ...
    self.pack   = [SCManager getPackage:[self.packId intValue]];
    self.clips  = [self.pack objectForKey:@"clips"];
    NSString *packThumbnail = [self.pack objectForKey:@"view_image"];
    self.thumbnail.image = [UIImage imageWithData:[NSData dataWithContentsOfURL:[NSURL URLWithString:packThumbnail]]];
